...
const UI = {
  en:{
    ...
    time_closed:'The clinic is closed on this day — please pick another date.', time_selectPrompt:'Please select a time',
  ...
  zh:{
    ...
    time_closed:'诊所当天不营业，请选择其他日期。', time_selectPrompt:'请选择时间',
  ...
  ms:{
    ...
    time_closed:'Klinik tutup pada hari ini — sila pilih tarikh lain.', time_selectPrompt:'Sila pilih masa',
