...
const UI = {
  en:{
    ...
    duty_weekTitle:"This Week's Schedule", duty_weekSub:'Plan your visit — see which doctor is on duty each day this week.', duty_todayBadge:'Today',
    booking_title:'Book an Appointment', booking_subtitle:'Fill in your details and we will confirm your slot shortly.',
    booking_name:'Full Name', booking_phone:'Phone Number', booking_date:'Preferred Date', booking_slot:'Preferred Slot', booking_time:'Preferred Time', booking_service:'Service', booking_doctorPref:'Doctor Preference', booking_noPref:'No preference', booking_notes:'Notes (optional)', booking_submit:'Submit Booking',
    booking_phonePlaceholder:'e.g. 012-345 6789', booking_phoneInvalid:'Please enter a valid Malaysian phone number, e.g. 012-345 6789.',
    booking_email:'Email (optional)', booking_emailPlaceholder:'e.g. name@example.com', booking_emailInvalid:'Please enter a valid email address.',
    ...
    time_closed:'The clinic is closed on this day — please pick another date.', time_selectPrompt:'Please select a time', time_pastToday:'No more time slots available today — please pick another date.',
    ...
    highlight_discreet:'Private & Discreet Care', highlight_doctors:'Experienced Doctors', highlight_panel:'Trusted by 20+ Panels & Corporates',
    ...
    wa_modal_title:'Quick WhatsApp Appointment', wa_modal_subtitle:"Fill this in and we'll pre-fill your WhatsApp message so you don't have to type it out.",
    wa_modal_reason:'Reason / Symptom', wa_modal_reasonPlaceholder:'e.g. fever, follow-up, MC needed',
    wa_modal_submit:'Continue to WhatsApp', wa_modal_cancel:'Cancel',
    wa_modal_note:"We'll also save this request in our system so our staff can see it.",
    wa_modal_validation:'Please fill in your name, reason, date and pick a time.',
    col_time:'Time',
    ...
    dash_greetMorning:'Good morning', dash_greetAfternoon:'Good afternoon', dash_greetEvening:'Good evening', dash_overview:"Here's today's overview.",
    dash_openToday:'Open Today', dash_closedToday:'Closed Today', dash_weekAppts:'This Week', dash_staffOnDuty:'Staff on Duty Today', dash_noRoster:'Not set yet',
    dash_recentAppts:'Recent Appointments', dash_viewAll:'View All →',
    dash_qlSlotsDesc:'Set weekly doctor schedules', dash_qlNoticesDesc:'Post rest day or closure notices', dash_qlApptsDesc:'Review and confirm bookings',
    dash_qlTimetableDesc:'Manage internal staff roster', dash_qlSheetsDesc:'Quick access to shared spreadsheets', dash_qlGuidelinesDesc:'New staff onboarding checklist',
    ...
    slots_title:'Doctor Slot Assignment', slots_sub:"Set each doctor's working slots for the whole week at a glance — no more clicking day by day.", slots_date:'Date', slots_current:'Current:',
    slots_doctor:'Doctor', slots_off:'Off', slots_hint:'Click a cell to cycle through: Off → Morning → Afternoon → Both. Then click Save Week to apply.',
    slots_prevWeek:'‹ Previous Week', slots_nextWeek:'Next Week ›', slots_thisWeek:'This Week',
    slots_copyPrev:'Copy Previous Week', slots_clearWeek:'Clear Week', slots_saveWeek:'Save Week',
  ...
  zh:{
    ...
    duty_weekTitle:'本周排班', duty_weekSub:'提前规划您的就诊 — 查看本周每天的当值医生。', duty_todayBadge:'今天',
    booking_title:'预约挂号', booking_subtitle:'填写您的资料，我们将尽快确认预约时间。',
    booking_name:'姓名', booking_phone:'联络电话', booking_date:'预约日期', booking_slot:'时段选择', booking_time:'预约时间', booking_service:'服务项目', booking_doctorPref:'指定医生', booking_noPref:'不指定', booking_notes:'备注（选填）', booking_submit:'提交预约',
    booking_phonePlaceholder:'例如：012-345 6789', booking_phoneInvalid:'请输入有效的马来西亚电话号码，例如：012-345 6789。',
    booking_email:'电邮（选填）', booking_emailPlaceholder:'例如：name@example.com', booking_emailInvalid:'请输入有效的电邮地址。',
    ...
    time_closed:'诊所当天不营业，请选择其他日期。', time_selectPrompt:'请选择时间', time_pastToday:'今天已没有可预约的时段，请选择其他日期。',
    ...
    highlight_discreet:'私密与保密医疗', highlight_doctors:'经验丰富的医生', highlight_panel:'获20+机构及企业信赖',
    ...
    wa_modal_title:'快速WhatsApp预约', wa_modal_subtitle:'填写以下资料，我们会为您预先填好WhatsApp讯息，您就不需要自己打字了。',
    wa_modal_reason:'原因/症状', wa_modal_reasonPlaceholder:'例如：发烧、复诊、需要病假单',
    wa_modal_submit:'前往WhatsApp', wa_modal_cancel:'取消',
    wa_modal_note:'我们也会将此请求保存在系统中，方便员工查看。',
    wa_modal_validation:'请填写姓名、原因、日期并选择时间。',
    col_time:'时间',
    dash_welcome:'欢迎回来', dash_newAppts:'新预约', dash_todayNotice:'今日通知', dash_noNotice:'正常营业中', dash_quickLinks:'快速链接',
    dash_greetMorning:'早上好', dash_greetAfternoon:'下午好', dash_greetEvening:'晚上好', dash_overview:'这是今日概览。',
    dash_openToday:'今日营业', dash_closedToday:'今日休息', dash_weekAppts:'本周预约', dash_staffOnDuty:'今日当值员工', dash_noRoster:'尚未设置',
    dash_recentAppts:'最新预约', dash_viewAll:'查看全部 →',
    dash_qlSlotsDesc:'设置每周医生排班', dash_qlNoticesDesc:'发布休息或不营业通知', dash_qlApptsDesc:'查看并确认预约',
    dash_qlTimetableDesc:'管理内部员工排班', dash_qlSheetsDesc:'快速访问共享表格', dash_qlGuidelinesDesc:'新员工入职清单',
    ...
    slots_title:'医生排班设置', slots_sub:'一次查看并设置整周每位医生的当值时段，无需逐日点击。', slots_date:'日期', slots_current:'当前：',
    slots_doctor:'医生', slots_off:'休', slots_hint:'点击格子可切换：休 → 上午 → 下午 → 全天。设置完成后点击"保存本周"以生效。',
    slots_prevWeek:'‹ 上一周', slots_nextWeek:'下一周 ›', slots_thisWeek:'本周',
    slots_copyPrev:'复制上周设置', slots_clearWeek:'清空本周', slots_saveWeek:'保存本周',
  ...
  ms:{
    ...
    duty_weekTitle:'Jadual Minggu Ini', duty_weekSub:'Rancang lawatan anda — lihat doktor yang bertugas pada setiap hari minggu ini.', duty_todayBadge:'Hari Ini',
    booking_title:'Tempah Temujanji', booking_subtitle:'Isi maklumat anda dan kami akan sahkan slot anda tidak lama lagi.',
    booking_name:'Nama Penuh', booking_phone:'Nombor Telefon', booking_date:'Tarikh Pilihan', booking_slot:'Slot Pilihan', booking_time:'Masa Pilihan', booking_service:'Perkhidmatan', booking_doctorPref:'Pilihan Doktor', booking_noPref:'Tiada keutamaan', booking_notes:'Nota (pilihan)', booking_submit:'Hantar Tempahan',
    booking_phonePlaceholder:'cth. 012-345 6789', booking_phoneInvalid:'Sila masukkan nombor telefon Malaysia yang sah, cth. 012-345 6789.',
    booking_email:'E-mel (pilihan)', booking_emailPlaceholder:'cth. name@example.com', booking_emailInvalid:'Sila masukkan alamat e-mel yang sah.',
    ...
    time_closed:'Klinik tutup pada hari ini — sila pilih tarikh lain.', time_selectPrompt:'Sila pilih masa', time_pastToday:'Tiada lagi slot masa tersedia hari ini — sila pilih tarikh lain.',
    ...
    highlight_discreet:'Penjagaan Peribadi & Sulit', highlight_doctors:'Doktor Berpengalaman', highlight_panel:'Dipercayai oleh 20+ Panel & Korporat',
    ...
    wa_modal_title:'Tempahan Pantas melalui WhatsApp', wa_modal_subtitle:'Isi maklumat ini dan kami akan pra-isi mesej WhatsApp anda supaya anda tidak perlu menaipnya.',
    wa_modal_reason:'Sebab / Simptom', wa_modal_reasonPlaceholder:'cth: demam, susulan, perlu MC',
    wa_modal_submit:'Teruskan ke WhatsApp', wa_modal_cancel:'Batal',
    wa_modal_note:'Kami juga akan menyimpan permintaan ini dalam sistem kami supaya staf kami dapat melihatnya.',
    wa_modal_validation:'Sila isi nama, sebab, tarikh dan pilih masa anda.',
    col_time:'Masa',
    ...
    dash_greetMorning:'Selamat Pagi', dash_greetAfternoon:'Selamat Tengah Hari', dash_greetEvening:'Selamat Petang', dash_overview:'Berikut ialah gambaran keseluruhan hari ini.',
    dash_openToday:'Beroperasi Hari Ini', dash_closedToday:'Tutup Hari Ini', dash_weekAppts:'Minggu Ini', dash_staffOnDuty:'Staf Bertugas Hari Ini', dash_noRoster:'Belum ditetapkan',
    dash_recentAppts:'Temujanji Terkini', dash_viewAll:'Lihat Semua →',
    dash_qlSlotsDesc:'Tetapkan jadual mingguan doktor', dash_qlNoticesDesc:'Siarkan notis hari rehat atau penutupan', dash_qlApptsDesc:'Semak dan sahkan tempahan',
    dash_qlTimetableDesc:'Urus jadual staf dalaman', dash_qlSheetsDesc:'Akses pantas ke helaian dikongsi', dash_qlGuidelinesDesc:'Senarai semak orientasi staf baharu',
    ...
    slots_title:'Penetapan Slot Doktor', slots_sub:'Tetapkan slot bekerja setiap doktor untuk sepanjang minggu sekali gus — tidak perlu klik hari demi hari.', slots_date:'Tarikh', slots_current:'Semasa:',
    slots_doctor:'Doktor', slots_off:'Tiada', slots_hint:'Klik sel untuk menukar: Tiada → Pagi → Petang → Kedua-dua. Kemudian klik Simpan Minggu untuk menggunakannya.',
    slots_prevWeek:'‹ Minggu Lepas', slots_nextWeek:'Minggu Depan ›', slots_thisWeek:'Minggu Ini',
    slots_copyPrev:'Salin Minggu Lepas', slots_clearWeek:'Kosongkan Minggu', slots_saveWeek:'Simpan Minggu',
